...
def parseArguments():
    ...
    parser = argparse.ArgumentParser(parents=[get_args(), other_args],
...
def main(args=None):
    ...
    if all(var_list):
        ...
        sys.stderr.write("WARNING: Not all input files contain the 'chrom', 'start', 'end' information. "
